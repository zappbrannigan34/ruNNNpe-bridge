...
1. On first launch, app requests BLE, Health Connect core permissions, notifications, optional route write, optional location anchor permission, and battery optimization exemption.
